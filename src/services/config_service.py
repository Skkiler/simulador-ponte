...
class ConfigService:
    ...
    def normalize(self, cfg: Dict[str, Any]) -> Dict[str, Any]:
        ...
        member_sizing_cfg.setdefault("late_nominal_topoff_max_trials", 12)
        member_sizing_cfg.setdefault("enable_late_multicase_strength_reinvestment", True)
        member_sizing_cfg.setdefault("enable_late_basic_7030_target_recovery", True)
        member_sizing_cfg.setdefault("late_basic_target_nominal_kgf", 100.0)
        member_sizing_cfg.setdefault("late_basic_target_7030_kgf", 80.0)
        member_sizing_cfg.setdefault("late_basic_target_case", "center")
        member_sizing_cfg.setdefault("late_basic_target_cases", ["center", "torsion_60_40", "torsion_70_30"])
        member_sizing_cfg.setdefault("late_basic_target_max_proxy_mass_ratio", 0.995)
        member_sizing_cfg.setdefault("late_basic_nominal_max_iterations", 6)
        member_sizing_cfg.setdefault("late_basic_multicase_max_iterations", 6)
        member_sizing_cfg.setdefault("late_basic_max_trials", 16)
        member_sizing_cfg.setdefault("late_basic_max_donor_prefixes", 8)
        member_sizing_cfg.setdefault("late_basic_nominal_groups", ["top_chord", "vertical"])
        member_sizing_cfg.setdefault("late_basic_multicase_critical_groups", ["vertical", "top_chord"])
        member_sizing_cfg.setdefault("late_basic_multicase_donor_groups", ["support_pad", "bottom_chord", "diagonal", "top_chord"])
        member_sizing_cfg.setdefault("late_basic_min_abs_force_N", 25.0)
        member_sizing_cfg.setdefault("late_basic_nominal_multi_retention", 0.995)
        member_sizing_cfg.setdefault("late_basic_min_multi_gain_kgf", 0.03)
        member_sizing_cfg.setdefault("late_basic_min_nominal_gain_kgf", 0.10)
        member_sizing_cfg.setdefault("late_basic_donor_fs_threshold", 5.0)
        member_sizing_cfg.setdefault("late_basic_critical_fs_threshold", 1.40)
        member_sizing_cfg.setdefault("late_multicase_reinvest_max_iterations", 2)
        member_sizing_cfg.setdefault("late_multicase_reinvest_max_critical_trials", 2)
        member_sizing_cfg.setdefault("late_multicase_reinvest_max_donor_prefixes", 4)
        member_sizing_cfg.setdefault("late_multicase_reinvest_critical_fs_threshold", 1.35)
        member_sizing_cfg.setdefault("late_multicase_reinvest_donor_fs_threshold", 5.0)
        member_sizing_cfg.setdefault("late_multicase_reinvest_min_abs_force_N", 25.0)
        member_sizing_cfg.setdefault("late_multicase_reinvest_min_break_gain_kgf", 0.15)
        member_sizing_cfg.setdefault("late_multicase_reinvest_min_fs_gain_ratio", 1.002)
        member_sizing_cfg.setdefault("late_multicase_reinvest_max_proxy_mass_ratio", 0.995)
        member_sizing_cfg.setdefault("late_multicase_reinvest_proxy_mass_margin_g", 0.0)
        member_sizing_cfg.setdefault("late_multicase_reinvest_critical_groups", ["vertical", "top_chord"])
        member_sizing_cfg.setdefault("late_multicase_reinvest_donor_groups", ["bottom_chord", "support_pad", "diagonal", "top_chord"])
        member_sizing_cfg.setdefault("late_multicase_reinvest_cases", ["center", "torsion_60_40", "torsion_70_30"])
        member_sizing_cfg.setdefault("late_multicase_reinvest_full_revalidate", False)
